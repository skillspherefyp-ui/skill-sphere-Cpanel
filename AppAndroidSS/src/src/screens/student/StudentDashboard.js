  ...
  return (
    <Animated.View entering={FadeInDown.duration(400).delay(200)}>
      <View style={[streakCardStyles.card, {
        ...
        <View style={[streakCardStyles.heroRow, isMobile && { flexDirection: 'column', alignItems: 'center', gap: 12 }]}>

          {/* Left: shield badge */}
          <View style={[streakCardStyles.badgeCol, isMobile && { width: '100%', alignItems: 'center' }]}>
            <AnimatedStreakBadge
          ...
          <View style={[streakCardStyles.contentCol, isMobile && { width: '100%' }]}>
